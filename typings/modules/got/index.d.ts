...
declare module '~got~es6-promise/dist/es6-promise' {
...
declare module '~got~es6-promise' {
import alias = require('~got~es6-promise/dist/es6-promise');
export = alias;
}
...
import { Promise } from '~got~es6-promise';
...
declare module 'got/index' {
import alias = require('~got/index');
export = alias;
}
declare module 'got' {
import alias = require('~got/index');
